...
/**
 * The RangeBar is a double-sided version of a {@link android.widget.SeekBar} with discrete values.
 * Whereas the thumb for the SeekBar can be dragged to any position in the bar, the RangeBar only
 * allows its thumbs to be dragged to discrete positions (denoted by tick marks) in the bar. When
 * released, a RangeBar thumb will snap to the nearest tick mark.
 * <p>
 * Clients of the RangeBar can attach a {@link RangeBar#OnRangeBarChangeListener} to be notified
 * when the thumbs have been moved.
 */
public class RangeBar extends View {
    ...
    private static final int DEFAULT_THUMB_IMAGE_NORMAL = R.drawable.ico_seekbar_thumb;
    private static final int DEFAULT_THUMB_IMAGE_PRESSED = R.drawable.ico_seekbar_thumb;
     ...
     * 
     * @param thumbNormalID Integer specifying the resource ID of the image to be drawn as the
     *            normal thumb.
     */
     ...
     * 
     * @param pressedThumbID Integer specifying the resource ID of the image to be drawn as the
     *            pressed thumb.
     */
    ...
    /**
     * If this is set, the thumb images will be replaced with a circle. The normal image will be of
     * the specified color.
     * 
    ...
    /**
     * If this is set, the thumb images will be replaced with a circle. The pressed image will be of
     * the specified color.
     * 
    ...
    /**
     * Sets the location of each thumb according to the developer's choice. Numbered from 0 to
     * mTickCount - 1 from the left.
     * 
    ...
    private void rangeBarInit(Context context, AttributeSet attrs)
    {
        ...
        try {
            ...
            // attributes.
            final Integer tickCount = ta.getInteger(R.styleable.RangeBar_tickCount,
                    DEFAULT_TICK_COUNT);
